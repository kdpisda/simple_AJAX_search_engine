    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--primary">
        ...
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect mdl-color--primary-dark">
          ...
          <a href="#scholarships" class="mdl-layout__tab">Scholarships</a>
          <a href="#features" class="mdl-layout__tab">Contact Us</a>
...
<main class="mdl-layout__content">
        ...
        <div class="mdl-layout__tab-panel" id="scholarships">
          <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
                <center>
                    <ul class="demo-list-three mdl-list" style="text-align: justify;">
                        <li class="mdl-list__item mdl-list__item--three-line">
                            <span class="mdl-list__item-primary-content">
                                <i class="material-icons mdl-list__item-avatar">&#xE887;</i>
                                <span>To help the students</span>
                                <span class="mdl-list__item-text-body">
                                    When we were students we thought that we have enough knowledge
                                    about the world about many things but when we reached the college
                                    we realised that if we could have known it earlier we could have
                                    done better now so the upcoming batches must not face these problems
                                    keeping this in mind we are developing this platform.
                                </span>
                            </span>
                        </li>
                        <li class="mdl-list__item mdl-list__item--three-line">
                            <span class="mdl-list__item-primary-content">
                                <i class="material-icons  mdl-list__item-avatar">&#xE923;</i>
                                <span>To Keep students updated</span>
                                <span class="mdl-list__item-text-body">
                                    Basically when the students are in 12std or so they start searching
                                    like which carrer option is best for them or they Google for the best 
                                    colleges or like so. Yup right guess to show students right path about 
                                    career, and to share the problems which they may need to face.
                                </span>
                            </span>
                        </li>
                        <li class="mdl-list__item mdl-list__item--three-line">
                            <span class="mdl-list__item-primary-content">
                                <i class="material-icons  mdl-list__item-avatar">&#xE150;</i>
                                <span>Because we are NAVODAYANS</span>
                                <span class="mdl-list__item-text-body">
                                    No reason needed To Navodayans, For Navodayans, By Navodayans.
                                </span>
                            </span>
                        </li>
                    </ul>
          ...
          <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
              ...
              <div class="mdl-card__actions">
                <a href="scholarship" class="mdl-button">Click here for searching scholarship</a>
              </div>
            </div>
            <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon" id="btn3">
              <i class="material-icons">more_vert</i>
